...
class CreatePage {
  ...
  _setupEventListeners() {
    ...
    document
      ...
      .addEventListener("click", () => this._openCamera());
    document
    ...
    document
      ...
      .addEventListener("click", () => this._removeImage());
  ...
  async _openCamera() {
    try {
      ...
      if (error.name === "NotAllowedError") {
        errorMessage +=
          "Harap izinkan akses kamera di pengaturan browser Anda.";
  ...
  _capturePhoto() {
    ...
    canvas.toBlob(
      (blob) => {
        ...
        showAlert(
          "Foto diambil! Sekarang kamu dapat menambahkan deskripsi dan lokasi",
          "success"
        );
      },
      "image/jpeg",
